    ...
    <Sheet open={open} onOpenChange={handleOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-md">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <Field htmlFor="student-admissionNo" label="Admission No *" error={form.formState.errors.admissionNo?.message}>
            <Input
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field htmlFor="student-firstName" label="First Name *" error={form.formState.errors.firstName?.message}>
              <Input id="student-firstName" {...form.register("firstName")} placeholder="e.g. Amina" disabled={busy} />
            </Field>

            <Field htmlFor="student-lastName" label="Last Name *" error={form.formState.errors.lastName?.message}>
              <Input id="student-lastName" {...form.register("lastName")} placeholder="e.g. Otieno" disabled={busy} />
            </Field>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <Field htmlFor="student-gender" label="Gender" error={form.formState.errors.gender?.message}>
              <Select
            ...
            <Field htmlFor="student-dob" label="DOB" error={form.formState.errors.dob?.message}>
              <Input id="student-dob" type="date" {...form.register("dob")} disabled={busy} />
            </Field>
          </div>

          <Field htmlFor="student-classId" label="Class" error={form.formState.errors.classId?.message}>
            <Select
            ...
            >
              <SelectTrigger id="student-classId">
